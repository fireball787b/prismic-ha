...
export default async function ProductsPage({
    ...
    return (
        <section className="max-w-4xl mx-auto px-4 py-8 text-gray-900">
            {/* PRODUCT NAME */}
            <h1 className="text-4xl font-bold mb-6">{product.name}</h1> {/* Increased bottom margin */}
            ...
            {product.image && (
                <Image
                    ...
                    width={360}
                    height={360}
                    className="w-full h-auto rounded-md mb-10 object-cover" // Added more margin below
                />
            )}

            <div className="mb-10"> {/* Extra spacing between blocks */}
